//
//  ListOfKindergartenTableViewCell.swift
//  BFA
//
...
class ListOfKindergartenTableViewCell: UITableViewCell{
    ...
    var uploadBtn : UIButton = UIButton()
    ...
    private func configView() {
        ...
        uploadBtn.backgroundColor = UIColor(hexString: "#3868F6")
        uploadBtn.setImage(UIImage(named: "upload"), for: .normal)
        ...
        inactiveStatusLab.snp.makeConstraints { (make) in
            make.right.equalTo(uploadBtn.snp_left).offset(-4 * AutoSizeScaleX)
