...
//    }
    ...
    open override var intrinsicContentSize: CGSize {
        return CGSize(width: tableView.contentSize.width, height: tableView.contentSize.height)
    }
...
class SelectionListCell: UITableViewCell {
    ...
    func updateSelectionAppearance() {
        selectionImage = UIImage(named: "checkmark-outline")
        deselectionImage = UIImage(named: "circle-outline")
    ...
    override func layoutSubviews() {
       ...
       // imageViewFrame.origin.x = Screen_Width - imageViewOriginX - 60 * AutoSizeScaleX
